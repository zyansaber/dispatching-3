...
export interface TransportEmailData {
  ...
  transportDealer?: string | null;
  previousCompany?: string | null;
  previousDealer?: string | null;
...
interface TransportTemplateParams {
  ...
  transport_dealer: string;
  previous_company: string;
  previous_dealer: string;
  action_type: string;
  updated_at: string;
  to_name: string;
  from_name: string;
...
const buildTransportTemplateParams = (data: TransportEmailData): TransportTemplateParams => ({
  ...
  transport_dealer: safeText(data.transportDealer, 'Unassigned'),
  previous_company: safeText(data.previousCompany, 'N/A'),
  previous_dealer: safeText(data.previousDealer, 'N/A'),
