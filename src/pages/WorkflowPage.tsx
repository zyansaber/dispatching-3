  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
                  Auto-loaded interface cues
                </p>
                <h3 className="text-xl font-bold text-slate-100">
                  Screenshots & button usage highlights
                </h3>
              </div>
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <Card className="border border-slate-800 bg-slate-900/70">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">Dispatch dashboard snapshot</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
                    Auto-captured when a new update arrives.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border border-slate-800 bg-slate-900/70">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">Report button preview</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
                    See exactly where to click for Planning reviews.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="overflow-hidden rounded-lg border border-slate-800/70 bg-slate-900/70">
            ...
            <div className="mt-4 rounded-xl border border-slate-800 bg-slate-900/60 p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-300">KPI Focus</div>
              <h4 className="mt-2 text-lg font-semibold text-slate-100">Performance targets</h4>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-border/80 shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg">Issue shooting & escalation</CardTitle>
            <CardDescription>Who to contact when something is blocked.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-slate-700">
            <ul className="list-inside list-disc space-y-2 text-slate-600">
              <li>No PO created yet: contact Purchasing Officer Karen Andrew.</li>
              <li>SAP PGI or Goods Issue problems: contact SAP Master Stefan Peng.</li>
              <li>SAP data or website data mismatch: contact the Planning Team.</li>
              <li>Caravan not transferred into transport warehouse: contact Production (Maria).</li>
              <li>System updates, suggestions, or errors: contact Zhihai Yan.</li>
            </ul>
