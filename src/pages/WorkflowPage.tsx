...
const WorkflowPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <Card className="border-border/80 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-slate-100 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Critical operating systems</CardTitle>
          <CardDescription className="text-slate-300">
            Two core systems support daily dispatch operations.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">SAP GUI</div>
            <p className="mt-2 text-sm font-semibold text-slate-100">
              Live Data Stock and Main Operation for PGI
            </p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Dashboard UI</div>
            <p className="mt-2 text-sm font-semibold text-slate-100">
              Hourly refresh in working hour and Work process Control
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border/80 shadow-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="text-xs font-semibold uppercase tracking-[0.25em] text-slate-500">Workflow flowchart</div>
            {[
              {
                title: "Step 1 — Confirm visibility & understand why a caravan appears",
                label: "Check stock",
                tcode: "SAP Tcode: IQ09",
                color: "from-sky-100 via-sky-50 to-white text-sky-800 border-sky-200",
                content: (
                  <>
                    <p>
              ...
              },
              {
                ...
                color: "from-emerald-100 via-emerald-50 to-white text-emerald-800 border-emerald-200",
                content: (
              ...
              },
              {
                ...
                label: "Dealer check",
                color: "from-indigo-100 via-indigo-50 to-white text-indigo-800 border-indigo-200",
                content: (
                  <>
                    <p>
              ...
              },
              {
                ...
                color: "from-amber-100 via-amber-50 to-white text-amber-800 border-amber-200",
                content: (
                  <>
                    <p>
              ...
              },
              {
                ...
                label: "Print & PGI",
                tcode: "SAP Tcode: VL01N",
                color: "from-orange-100 via-orange-50 to-white text-orange-800 border-orange-200",
                content: (
                  <ul className="list-inside list-disc space-y-1">
              ...
              },
              {
                ...
                label: "Delivery docs",
                color: "from-purple-100 via-purple-50 to-white text-purple-800 border-purple-200",
                content: (
                  <ul className="list-inside list-disc space-y-1">
                    <li>
              ...
              },
              {
                ...
                label: "Damage & KPI",
                color: "from-rose-100 via-rose-50 to-white text-rose-800 border-rose-200",
                content: (
                  <>
                    <p>
              ...
              <div key={step.title} className="relative">
                <div className="grid gap-4 lg:grid-cols-[240px_1fr] lg:items-stretch">
                  <div className="flex h-full flex-col items-center">
                    <div
                      className={`flex h-full w-full max-w-[240px] flex-col justify-center rounded-2xl border bg-gradient-to-br px-4 py-4 text-center text-sm font-semibold shadow-sm ${step.color}`}
                    >
                      ...
                      {step.tcode && (
                        <div className="mt-1 text-[11px] font-semibold text-slate-600">{step.tcode}</div>
                      )}
                    </div>
      ...
      <Card className="border-border/80 shadow-sm">
        ...
        <CardContent>
            ...
            <table className="w-full text-left text-sm text-slate-700">
              ...
              <tbody className="divide-y divide-slate-200">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-semibold text-slate-900">Andy He</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
            ...
            <a className="ml-1 font-semibold text-slate-900" href="mailto:andy@regentrv.com.au">
              andy@regentrv.com.au
            </a>
            , Andy He for system review.
          </div>
        </CardContent>
      </Card>
    </div>
