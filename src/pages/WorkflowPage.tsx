  ...
  return (
    <div className="space-y-6">
      <Card className="border-border/80 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 shadow-sm">
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
              ...
              <p className="mt-2 text-sm text-slate-300">
                Vehicles are listed only after SAP production stock is moved into the transport warehouse. If it is not
          ...
          <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-semibold text-slate-100">Screenshots & button usage highlights</h3>
                </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Key buttons</div>
              <p className="mt-2 text-sm text-slate-300">
                Quick access to the most-used workflow actions.
              </p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-border/80 shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg">KPI targets</CardTitle>
            <CardDescription>How success is measured for dispatching teams.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-slate-700">
            <ul className="list-inside list-disc space-y-2 text-slate-600">
              <li>Dispatch within 3 days after transfer into your warehouse.</li>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                content: (
                  <ul className="list-inside list-disc space-y-1">
                    <li>Click Print Doc, select the vehicles, and confirm all information is complete.</li>
