...
const PGIHistoryPage: React.FC = () => {
  ...
  }, [dealerFilter, onlyNoGr, periodFilter, records, statusFilter, vendorFilter]);
            ...
            <div className="grid gap-3 lg:grid-cols-[220px_220px_1fr]">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  ...
                  onClick={() => setStatusFilter((prev) => (prev === "inTransit" ? "all" : "inTransit"))}
                >
                  In transit
                </Button>
                <Button
                ...
                <Button
                  ...
                  onClick={() => setStatusFilter((prev) => (prev === "missingPo" ? "all" : "missingPo"))}
                >
                  Missing PO
                </Button>
              </div>
